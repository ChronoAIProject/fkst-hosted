...
-- it stages an isolated workspace (this package + its libs + minimal effect-package
-- stubs whose departments consume the request queues this package produces), writes a
...
function H.setup_workspace(name, child_test)
  ...
  write_stub_package(root, "github-issue-effect")
  write_stub_package(root, "github-comment-effect")
  write_stub_department(root, "github-issue-effect", "github_issue_create", "github_issue_create_request")
...
function H.run_child(root)
  ...
  local command = table.concat({
    ...
    shell_quote(root .. "/packages/workflow-security"),
    "--package-root",
    shell_quote(root .. "/packages/github-issue-effect"),
    "--package-root",
