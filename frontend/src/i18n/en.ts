...
export const en: SiteContent = {
  ...
  dashboard: {
    ...
    update: 'Update',
    updating: 'Updating…',
    updatesNote: 'This dashboard updates only when you click Update.',
    lastUpdated: 'Last updated',
    never: 'never',
    updateFailed: 'Update failed. Please try again.',
    firstVisitTitle: 'Nothing loaded yet',
    firstVisitBody:
      'Click Update to load your repositories and fkst sessions. Pulling can take a moment — there are many GitHub calls under the hood.',
    loadingTitle: 'Loading your dashboard…',
    reposScanned: '{done} / {total} repositories',
    noRepos: 'No repositories with the fkst-hosted App installed.',
    ...
    repos: {
      ...
      searchEmpty: 'No repositories match your search.',
