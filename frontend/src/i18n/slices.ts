...
export type CanvasModalsSlice = Pick<
  ...
  | 'createAdvancedLabel'
  | 'createSourceBranchLabel'
  | 'createSourceBranchPlaceholder'
  | 'createTargetBranchLabel'
  | 'createTargetBranchPlaceholder'
  | 'createBranchInvalid'
  ...
  | 'createEnvironmentSaved'
  | 'createEnvironmentDisposable'
  ...
  | 'createDisposableAddInstall'
  | 'createDisposableRemoveInstall'
  | 'createDisposableVariablesLabel'
  | 'createDisposableSecretsLabel'
  | 'createDisposableNamePlaceholder'
  | 'createDisposableValuePlaceholder'
  | 'createDisposableSecretPlaceholder'
  | 'createDisposableAddVariable'
  | 'createDisposableAddSecret'
  | 'createDisposableRemoveVariable'
  | 'createDisposableRemoveSecret'
  | 'createDisposableImmutableNote'
  | 'createDisposableEmpty'
  | 'createDisposableConfirmTitle'
  | 'createDisposableConfirmBody'
  | 'createDisposableConfirmInstall'
  | 'createDisposableConfirmVariables'
  | 'createDisposableConfirmSecrets'
  | 'createDisposableConfirmWarning'
  | 'createDisposableConfirmBack'
  | 'createDisposableConfirmSubmit'
  | 'createDisposableConfirmPending'
  | 'createWorkLabelHint'
  ...
  | 'workItemBodyLabel'
  | 'workItemBodyHint'
  | 'workItemBodyModeAria'
  | 'workItemWrite'
  | 'workItemPreview'
  | 'workItemPreviewAria'
  | 'workItemPreviewEmpty'
  | 'workItemLabelNote'
  | 'workItemSubmit'
  | 'workItemPending'
  | 'workItemFailed'
