...
export const zh: SiteContent = {
  ...
  dashboard: {
    ...
    update: '更新',
    updating: '更新中…',
    updatesNote: '此仪表盘仅在你点击“更新”时才会刷新。',
    lastUpdated: '上次更新',
    never: '从未',
    updateFailed: '更新失败，请重试。',
    firstVisitTitle: '尚未加载任何数据',
    firstVisitBody:
      '点击“更新”以加载你的仓库和 fkst 会话。拉取可能需要一点时间 —— 背后会调用许多 GitHub 接口。',
    loadingTitle: '正在加载你的仪表盘…',
    reposScanned: '{done} / {total} 个仓库',
    noRepos: '没有安装了 fkst-hosted App 的仓库。',
