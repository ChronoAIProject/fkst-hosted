...
//! list the webhook builds a session from; `labels` is the issue lifecycle-label
//! vocabulary the trigger + watcher use. (There is no goal store or goal API in
//! v1 — a GitHub issue IS the unit of work.)
